...
final upDownLayout = Layout(
  ...
  pins: List.unmodifiable([
    Pin(index: 0, mainAxis: 4, crossAxis: 4, z: 4, startsOpen: false),
    Pin(index: 1, mainAxis: 0, crossAxis: 12, z: 4, startsOpen: false),
    Pin(index: 2, mainAxis: 3, crossAxis: 3, z: 3, startsOpen: false),
    Pin(index: 3, mainAxis: 3, crossAxis: 5, z: 3, startsOpen: false),
    Pin(index: 4, mainAxis: 1, crossAxis: 11, z: 3, startsOpen: false),
    Pin(index: 5, mainAxis: 1, crossAxis: 13, z: 3, startsOpen: false),
    ...
    Pin(index: 12, mainAxis: 1, crossAxis: 1, z: 1, startsOpen: false),
    Pin(index: 13, mainAxis: 1, crossAxis: 3, z: 1, startsOpen: false),
    Pin(index: 14, mainAxis: 1, crossAxis: 5, z: 1, startsOpen: false),
    Pin(index: 15, mainAxis: 1, crossAxis: 7, z: 1, startsOpen: false),
    Pin(index: 16, mainAxis: 3, crossAxis: 9, z: 1, startsOpen: false),
    Pin(index: 17, mainAxis: 3, crossAxis: 11, z: 1, startsOpen: false),
    Pin(index: 18, mainAxis: 3, crossAxis: 13, z: 1, startsOpen: false),
    Pin(index: 19, mainAxis: 3, crossAxis: 15, z: 1, startsOpen: false),
    Pin(index: 20, mainAxis: 0, crossAxis: 0, z: 0, startsOpen: true),
    Pin(index: 21, mainAxis: 0, crossAxis: 2, z: 0, startsOpen: true),
    Pin(index: 22, mainAxis: 0, crossAxis: 4, z: 0, startsOpen: true),
    Pin(index: 23, mainAxis: 0, crossAxis: 6, z: 0, startsOpen: true),
    Pin(index: 24, mainAxis: 0, crossAxis: 8, z: 0, startsOpen: true),
    Pin(index: 25, mainAxis: 2, crossAxis: 8, z: 0, startsOpen: true),
    Pin(index: 26, mainAxis: 4, crossAxis: 8, z: 0, startsOpen: true),
    Pin(index: 27, mainAxis: 4, crossAxis: 10, z: 0, startsOpen: true),
    Pin(index: 28, mainAxis: 4, crossAxis: 12, z: 0, startsOpen: true),
    Pin(index: 29, mainAxis: 4, crossAxis: 14, z: 0, startsOpen: true),
    Pin(index: 30, mainAxis: 4, crossAxis: 16, z: 0, startsOpen: true),
  ]),
  above: List.unmodifiable([
