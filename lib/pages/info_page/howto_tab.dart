        ...
        child: Column(
          ...
          children: [
            ExpandableBox(
              ...
              icon: Icon(Icons.play_arrow, color: colours.secondary),
              onTap: () => _onTap(0),
            ...
            ExpandableBox(
              ...
              icon: Icon(Icons.touch_app, color: colours.secondary),
              onTap: () => _onTap(1),
              child: Interaction(),
            ),
            ExpandableBox(
              ...
              title: Text("Scoring"),
              icon: Icon(Icons.star_border, color: colours.secondary),
              onTap: () => _onTap(2),
              child: Scoring(),
            ),
          ],
